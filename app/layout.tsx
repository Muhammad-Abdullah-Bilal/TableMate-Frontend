...
export const metadata: Metadata = {
  title: "TableMate | Intelligent Dining Assistant",
  description: "AI-powered smart restaurant ordering system. View the menu, get tailored suggestions, and order delicious food.",
};
